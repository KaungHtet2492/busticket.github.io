...
$sql = "SELECT * FROM bus_information";
...
?>
           <tr>
               ...
               <td>
                  <?php echo $row['fromplace']; ?>
               </td>
               <td>
                  <?php echo $row['toplace']; ?>
               </td>
               <td>
               ...
               <td>
                 <a href="edit.php?id=<?php echo $row['busid'];?>" id = "update-btn" >Update</a><br>
                 <a onclick="return confirm('Are you want to Delete?')" href="delete_user_accounts.php?id=<?php echo $row['busid'];?>" id = "delete-btn" >Delete</a>
               </td>
           </tr>
<?php 
    }
